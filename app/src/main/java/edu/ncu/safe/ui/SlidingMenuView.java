 ...
 */
public class SlidingMenuView extends SlidingMenu implements AdapterView.OnItemClickListener, View.OnClickListener, SlidingMenu.OnOpenedListener {
    ...
    public SlidingMenuView(Activity activity) {
        ...
        setBehindOffsetRes(R.dimen.slidingmenu_offset);// 设置滑动菜单视图的宽度
        setFadeDegree(0.35f);// 设置渐入渐出效果的值
        ...
        adapter = new MainMenuAdapter(activity, getMainMenuInfo());
