                ...
                try {
                    ...
                    if (processName.indexOf(":") != -1) {// :服务的命名
                        try {
                            ...
                            icon = applicationInfo != null ? applicationInfo.loadIcon(packageManager) : getDrawable(R.drawable.ic_launcher);
                            appName = processName;
        ...
        protected void onProgressUpdate(Object... values) {
            ...
            switch ((int)values[0]){
                ...
                case TASKPROGRESSEND:
                    ...
                    bundle.putParcelable("TaskProgressEnd", (RunningApplicationInfo)values[1]);break;
                case TASKCANCEL:
                case TASKEND:
