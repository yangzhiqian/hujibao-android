package com.lhm.http.okhttp.request;


import com.lhm.http.okhttp.OkHttpClientManager;
import com.lhm.http.okhttp.callback.ResultCallback;
    ...
    public void invokeAsyn(final ResultCallback callback)
    {
        ...
        call.enqueue(new Callback()
        {
            ...
            public void onFailure(Call call, IOException e) {
                mOkHttpClientManager.sendFailResultCallback(call, e, callback);
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                {
                    e.printStackTrace();
                    OkHttpClientManager.getInstance().sendFailResultCallback(call, e, callback);
                }
            }
        });
