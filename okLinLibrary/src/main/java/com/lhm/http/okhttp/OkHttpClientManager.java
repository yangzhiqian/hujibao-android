    ...
    public void execute(Request request, ResultCallback callback) {
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                sendFailResultCallback(call, e, resCallBack);
            }
...
//            //林华明修改,一个参数的已经过期.两个参数的需要一个新的接口.
//            mOkHttpBuilder.sslSocketFactory(sslContext.getSocketFactory(), new X509TrustManager() {
//
//                @Override
